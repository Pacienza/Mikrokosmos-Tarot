...
footer_label = ttk.Label(
    root,
    text="Desenvolvido por Lucas Pacienza. 2024 \nTodos direitos reservados a VL Info®",
    font=("Arial", 10),
)
...
def energisa_sistema():
    ...
    if len(user_input.strip()) == 0:
        ...
        messagebox.showinfo(
            "Confirmação", "Sistema energizado com a intenção, prossiga para a consulta"
        )
...
store_button = ttk.Button(
    root,
    text="Enviar intenção para o sistema",
    bootstyle=LIGHT,
    command=energisa_sistema,
)
